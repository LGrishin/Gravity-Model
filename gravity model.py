...
class Block:
    ...
    def Mass(self):
        if self.cond == 0:
            self.lab = Label(text = 'Ââåäèòå êîëè÷åñòâî îáúåêòîâ', font = ("Comic Sans MS", 10, "bold"))
        else:
            self.lab= Label(text = 'Ââåäèòå ìàññó ' + str(self.p + 1) + ' îáúåêòà', font = ("Comic Sans MS", 10, "bold"))
        self.lab.pack()
        
        
root = Tk()
lab = Label(text = 'Ââåäèòå êîëè÷åñòâî îáúåêòîâ', font = ("Comic Sans MS", 10, "bold"))
lab.pack()
